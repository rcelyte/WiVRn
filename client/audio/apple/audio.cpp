...
wivrn::apple::audio::audio(const wivrn::to_headset::audio_stream_description &desc, wivrn_session &session, xr::instance &instance) {
...
void wivrn::apple::audio::operator()(wivrn::audio_data &&data) {
	if(this->output == nullptr)
		return;
...
void wivrn::apple::audio::get_audio_description(wivrn::from_headset::headset_info_packet& info) {
